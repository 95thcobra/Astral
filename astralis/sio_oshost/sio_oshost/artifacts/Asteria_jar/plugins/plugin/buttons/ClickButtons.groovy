...
final class ClickButtons implements PluginListener<ButtonClickPlugin> {
    ...
    void execute(Player player, ButtonClickPlugin context) {
		...
		if(player.rights.DEVELOPER || player.rights.ADMINISTRATOR)
			//player.messages.sendMessage "" + context.Output()
        switch (button) {
            case 9154:
                ...
                break
			case 9118: //close leather craft window
			player.messages.sendCloseWindows()
			break
			
			case 57225: //tan interface make 1
			case 57226:
			case 57227:
			case 57228:
			case 57229:
			...
			case 57231:
			case 57232:
			Crafting.tan_leather(player, button, 1)
			break
			
			
			case 57217: //tan interface make 5
			case 57218:
			case 57219:
			case 57220:
			case 57221:
			...
			case 57223:
			case 57224:
			Crafting.tan_leather(player, button, 5)
			break
			
			case 57209: //tan interface make x (did 10 for this)
			case 57210:
			case 57211:
			case 57212:
			case 57213:
			...
			case 57215:
			case 57216:
			Crafting.tan_leather(player, button, 10)
			break
			
			case 57201: //tan interface make all (did 28 == all for this)
			case 57202:
			case 57203:
			case 57204:
			case 57205:
			...
			case 57207:
			case 57208:
			Crafting.tan_leather(player, button, 28)
			break
			
			case 33187: //make leather items, Interface: 2311 (1 time)
			case 33190:
			case 34193:
			case 33196:
			case 33199:
			case 33202:
			case 33205:
			case 34185: //make 3 items, Interface: 8880 (1 time)
			case 34189:
			case 34193:
			case 34170: //make 2 items, Interface: 8869 (1 time)
			case 34174:
			if(player.getOptionList().isEmpty())
				return
			Item[] items = player.getOptionList().toArray(new Item[player.getOptionList().size()]);
			if(Crafting.leather_craft(player, items, button))
				return
			if(Fletching.fletch_test(player, items, button))
				return
				//player.messages.sendMessage "IF you see this message while action skilling, please contact a admin!"
			break
			
			case 33186: //make leather items, Interface: 2311 (5 time)
			case 33189:
			case 34192:
			case 33195:
			case 33198:
			case 33201:
			case 33204:
			case 34184: //make 3 items, Interface: 8880 (5 time)
			case 34188:
			case 34192:
			case 34169: //make 2 items, Interface: 8869 (5 time)
			case 34173:
			if(player.getOptionList().isEmpty())
				return
			Item[] items = player.getOptionList().toArray(new Item[player.getOptionList().size()]);
			...
			case 33185: //make leather items, Interface: 2311 (10 time)
			case 33188:
			case 34191:
			case 33194:
			case 33197:
			case 33200:
			case 33203:
			case 34183: //make 3 items, Interface: 8880 (10 time)
			case 34187:
			case 34191:
			case 34168: //make 2 items, Interface: 8869 (10 time)
			case 34172:
			if(player.getOptionList().isEmpty())
				return
			Item[] items = player.getOptionList().toArray(new Item[player.getOptionList().size()]);
			...
			case 34182: //make 3 items, Interface: 8880 (all time)
			case 34186:
			case 34190:
			case 34167: //make 3 items, Interface: 8869 (all time)
			case 34171:
			if(player.getOptionList().isEmpty())
				return
			Item[] items = player.getOptionList().toArray(new Item[player.getOptionList().size()]);
			...
			case 10239: //make 1 items, Interface: 4429 (1 time)
			case 10238: //make 5 items, Interface: 4429 (5 time)
			case 6212: //make x items, Interface: 4429 (10 time)
			case 6211: //make all items, Interface: 4429 (x time)
			if(player.getOptionList().isEmpty())
				return
			Item[] items = player.getOptionList().toArray(new Item[player.getOptionList().size()]);
			int button2 = button == 6212 ? 10237 : button == 6211 ? 10236 : button //need to set this due to how our fletch works
			if(Fletching.fletch_test(player, items, button2))
				return
				//player.messages.sendMessage "IF you see this message while action skilling, please contact a admin!"
			break
            ...
            case 17111:
				...
				//* ALL NEW MAGIC TELES
            case 50235: //Home
                player.teleport new Position(2965, 3380)
                break
			case 51005: //Draynor
				player.teleport new Position(3080, 3250)
				break
            case 21233:
            ...
            case 51133:
                player.autocastSpell = CombatSpells.AIR_BLAST.getSpell()
            ...
            case 30108:
                ...
                break
            default:
				if(Smithing.FurnaceInterface(player, button))
					return
                break
        }
    }
