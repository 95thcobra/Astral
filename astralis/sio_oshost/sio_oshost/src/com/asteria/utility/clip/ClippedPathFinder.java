...
public class ClippedPathFinder {
	...
	public void findRoute(CharacterNode c, int destX, int destY, boolean moveNear, int xLength, int yLength) {
		...
		c.getMovementQueue().addToPath(new Position(pathX, pathY));
