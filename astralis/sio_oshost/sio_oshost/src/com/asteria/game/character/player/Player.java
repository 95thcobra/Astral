...
public final class Player extends CharacterNode {
     ...
     */
    private final Stopwatch teleTabTimer = new Stopwatch().reset(), eatingTimer = new Stopwatch().reset(), potionTimer = new Stopwatch().reset(), tolerance = new Stopwatch(),
     ...
     *
     * @param session the I/O manager that manages I/O operations for this player.
     */
     ...
     *
     * @param position the position to move this player to.
     */
     ...
     *
     * @param skillAction the new value to set.
     */
     ...
     * @return the potion timer.
     */
    public Stopwatch getTabTeleTimer() {
        return teleTabTimer;
    }
     ...
     *
     * @param openShop the new value to set.
     */
     ...
     *
     * @param rangedAmmo the new value to set.
     */
     ...
     *
     * @param fireAmmo the new value to set.
     */
     ...
     *
     * @param usingStove the new value to set.
     */
     ...
     *
     * @param cookPosition the new value to set.
     */
     ...
     *
     * @param acceptAid the new value to set.
     */
     ...
     *
     * @param newPlayer the new value to set.
     */
     ...
     *
     * @param insertItem the new value to set.
     */
     ...
     *
     * @param withdrawAsNote the new value to set.
     */
     ...
     *
     * @param usernameHash the new value to set.
     */
